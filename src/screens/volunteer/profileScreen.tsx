    ...
    try {
      ...
      if (currentUser) {
        ...
        if (registeredUsers) {
          ...
          if (lastUser && lastUser.type === 'volunteer') {
            ...
            setUserData({
              ...
              phone: lastUser.tel || '',
              type: lastUser.type || 'volunteer',
              points: lastUser.points || 0
            });
            setLoading(false);
            return;
          }
          ...
          <View style={styles.profileSection}>
            <View style={styles.profileImageContainer}>
              <View style={styles.profileImage}>
                <Ionicons name="person" size={60} color={style.color.mainColor1} />
              </View>
              <TouchableOpacity 
            ...
            <Text style={styles.profileRole}>อาสาสมัคร</Text>
            {userData.points !== undefined && (
              <View style={styles.pointsContainer}>
                <Ionicons name="star" size={20} color="#FFD700" />
                <Text style={styles.pointsText}>{userData.points} คะแนน</Text>
              </View>
            )}
          </View>
