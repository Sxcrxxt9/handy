...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Image, Linking, Dimensions, Animated, Easing } from "react-native";
  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      position: "Developer",
      iconName: "code",
      iconColor: style.color.mainColor2,
      phone: "0820855888",
      instagram: "_poo.nn",
    },
    {
    ...
    <View key={member.id} style={styles.memberCard}>
      ...
      <View style={styles.memberInfo}>
        ...
        <View style={styles.contactButtons}>
          ...
          >
            <Ionicons name="call" size={20} color={style.color.mainColor2} />
    ...
    <SafeAreaView edges={['top']} style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          {/* <Text style={styles.headerSubtitle}>We are ready to help you 24/7</Text> */}
        </View>
...
const styles = StyleSheet.create({
  ...
  phoneButton: {
    flexDirection: "row",
    backgroundColor: style.color.mainColor2 + "15",
    paddingVertical: 8,
